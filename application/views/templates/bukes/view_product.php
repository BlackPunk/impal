...
<div class="container" id="view-product">
    <div class="row">
        ...
        <div class="col-sm-8">
            ...
            <div id="pages">
                <b><?= lang('sum_pages') ?>:</b> <?= $product['pages'] ?>
            </div>
            <div id="date_publish">
                <b><?= lang('datePublish') ?>:</b> <?= $product['datePublish'] ?>
            </div>
            <div id="isbn">
                <b>ISBN:</b> <?= $product['isbn'] ?>
            </div>
            <div id="publisher">
                <b><?= lang('publisher') ?>:</b> <?= $product['publisher'] ?>
            </div>
            <div id="weight">
                <b><?= lang('weight') ?>:</b> <?= $product['weight'] ?> kg
            </div>
            <div id="width">
                <b><?= lang('width') ?>:</b> <?= $product['width'] ?> cm
            </div>
            <div id="length">
                <b><?= lang('length') ?>:</b> <?= $product['length'] ?> cm
            </div>
        </div>
    </div>
