            ...
            <div class="panel-body">
                ...
                <form method="POST" action="">
                    ...
                    foreach ($languages as $language) { ?>
                        <div class="form-group">
                            <label id="smallflag" for="message-cookie-law">Message (<?= $language->name ?><img src="<?= base_url('attachments/lang_flags/' . $language->flag) ?>" alt="">)</label>
                    ...
                    foreach ($languages as $language) {
                        ?>
                        <div class="form-group">
                            <label id="smallflag" for="btn-cookie-law">Button Text (<?= $language->name ?><img src="<?= base_url('attachments/lang_flags/' . $language->flag) ?>" alt="">)</label>
                    ...
                    foreach ($languages as $language) { ?>
                        <div class="form-group">
                            <label id="smallflag" for="learn_more">Learn More (<?= $language->name ?><img src="<?= base_url('attachments/lang_flags/' . $language->flag) ?>" alt="">):</label>
