...
<?php if ($this->session->userdata('logged_in')) { ?>
    <footer>Powered by <a href="http://blackpunk.id">Blackpunk ID</a> / Developer <a href="https://github.com/Blackpunk">Amer</a></footer>
<?php } ?>
</div>
<!-- Modal Calculator -->
...
<script src="<?= base_url('assets/bootstrap-datetimepicker/js/bootstrap-datetimepicker.js') ?>"></script>
